...
public class NailReservation {
    ...
    @Builder
    private NailReservation(Long userId, String userName, Long storeId, String storeName, NailCategory nailCategory, LocalDate reservationDate, NailReservationTime reservationTime) {
        this.userId = userId;
    ...
    public static NailReservation of(Long userId, String userName, Long storeId, String storeName, NailCategory nailCategory, LocalDate reservationDate, NailReservationTime reservationTime) {
